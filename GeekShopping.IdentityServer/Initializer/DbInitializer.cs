...
namespace GeekShopping.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            _role.CreateAsync(new IdentityRole("Admin")).GetAwaiter().GetResult();
            _role.CreateAsync(new IdentityRole("Client")).GetAwaiter().GetResult();


            ApplicationUser admin = new ApplicationUser()
            {
                UserName = "cleane2003",
                Email = "cleane.batista@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (13) 12345-6789",
                FirstName = "Cleane",
                LastName = "Batista"
            };
